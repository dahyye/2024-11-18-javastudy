...
public class 컬렉션_3_ArrayList {
	...
	public static void main(String[] args) {
		...
		for(Object std :list)
		{
			...
			String ss = String.format("%.2f", (s.getKor()+s.getMath()+s.getEng())/3.0);
			System.out.println(s.getHakbun()+" "+s.getName()+" "+s.getKor()+" "+s.getEng()+" "+s.getMath()+" "+(s.getKor()+s.getMath()+s.getEng())+" "+ss);
		}
