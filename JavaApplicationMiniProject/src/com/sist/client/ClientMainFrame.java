...
implements ActionListener,Runnable, MouseListener
{
	...
	// 배치 
    // 데이터베이스 
    int selectRow=-1; //마우스에서 선택이 안되면 -1 
	...
	{  
		...
		mf.b7.addActionListener(this);//원래는 뉴스인데 디테일 확인하려고
		...
		cp.cp.b1.addActionListener(null);//쪽지보내기
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if(e.getSource()==cp.cp.b2) //상세보기 누르면
		{
			if(selectRow==-1)
			{
